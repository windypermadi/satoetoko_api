...
switch ($tag) {
    ...
    case "addtransaksi":
        ...
        $cektemp = $conn->query("SELECT * FROM saldo WHERE id_supplier = '8649ac8d33eb4f2a8d2a683e686ace19'")->num_rows;
        $temp = mysqli_fetch_object($conn->query("SELECT * FROM saldo WHERE id_supplier = '8649ac8d33eb4f2a8d2a683e686ace19' ORDER BY tanggal_posting DESC"));
