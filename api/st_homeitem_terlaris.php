...
total_dibeli, total_disukai FROM master_item WHERE status_aktif = 'Y' AND status_approve = '2' AND status_hapus = 'N' ORDER BY total_dibeli DESC LIMIT $offset, $limit");
