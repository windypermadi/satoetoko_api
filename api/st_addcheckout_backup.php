...
//             WHERE a.id_barang = '$dataproduk[id_master]' AND a.id_variant = '$dataproduk[id_variant]' 
//             AND a.id_user = '$datarow2[id_user]'
...
foreach ($dataproduk as $i => $key) {
    ...
    //         LEFT JOIN supplier f ON b.id_supplier = f.id_supplier 
    //         LEFT JOIN stok g ON b.id_master = g.id_barang 
    //         WHERE a.id_barang = '$idbarang' AND a.id_user = '$datarow->id_user'
    //         AND a.id_gudang = '$datarow->id_cabang'")->fetch_object();
    $getproduk[] = $conn->query("SELECT 
            b.id_master, 
            b.judul_master, 
            b.image_master, 
